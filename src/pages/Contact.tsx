            ...
            <div className="lg:col-span-1 space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Whether you have a question about our programs, donations, volunteering, or anything else, our team is ready to answer all your questions.
                </p>
              </div>

              <div className="space-y-6">
                <div className="flex items-start">
                  <MapPin className="h-6 w-6 text-charity-blue mr-4 mt-1" />
                  <div>
                ...
                <div className="flex items-start">
                  <Phone className="h-6 w-6 text-charity-blue mr-4 mt-1" />
                  <div>
                ...
                <div className="flex items-start">
                  <Mail className="h-6 w-6 text-charity-blue mr-4 mt-1" />
                  <div>
                    <h3 className="text-lg font-medium text-gray-900">Email</h3>
                    <p className="text-gray-600 mt-1">
                      info@brighterfutures.org<br />
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-400 hover:text-charity-blue transition-colors">
            ...
            <div className="lg:col-span-2 bg-gray-50 p-8 rounded-lg shadow-sm">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full bg-charity-blue hover:bg-charity-blue-light" disabled={isSubmitting}>
